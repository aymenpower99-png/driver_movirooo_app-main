...
class _DriverNotificationsPageState extends State<DriverNotificationsPage> {
  // Booking updates
  bool _bookingPush = false;
  bool _bookingSms = false;
  bool _bookingEmail = true;
          ...
          _NotificationCard(
            ...
            children: [
              _SimpleToggleRow(
                ...
                value: _bookingPush,
                onChanged: (v) => setState(() => _bookingPush = v),
              ),
              _CardDivider(),
              _SimpleToggleRow(
                label: t('sms'),
                value: _bookingSms,
                onChanged: (v) => setState(() => _bookingSms = v),
              ),
              _CardDivider(),
              _SimpleToggleRow(
                label: t('email'),
                ...
                value: _bookingEmail,
                onChanged: (v) => setState(() => _bookingEmail = v),
              ),
            ],
          ),
...
/// A simple toggle row — no icon, matches the screenshot style exactly
      ...
      child: Row(
        children: [
          ...
          Switch.adaptive(
            value: value,
            onChanged: onChanged,
            activeTrackColor: AppColors.primaryPurple, // ← your purple kept
          ),
        ],
      ),
    );

...
import 'package:moviroo_driver_app/theme/app_text_styles.dart';
import 'package:moviroo_driver_app/core/models/ride_model.dart';
              ...
              children: [
                RideInfoChip(
                  ...
                  label: ride.scheduledAt != null
                      ? formatRideDate(DateTime.parse(ride.scheduledAt!))
                      : '—',
                ),
                ...
                RideInfoChip(
                  ...
                  label: ride.scheduledAt != null
                      ? formatRideTime(DateTime.parse(ride.scheduledAt!))
                      : '—',
                ),
                const SizedBox(width: 14),
                RideInfoChip(
